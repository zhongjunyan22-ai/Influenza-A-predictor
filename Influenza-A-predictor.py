...
# 数值型变量输入框
age = st.number_input("年龄:", min_value=0, max_value=120, value=8.0)  
WBC = st.number_input("白细胞计数:", min_value=0, max_value=200, value=5.69) 
PNEUT = st.number_input("中性粒细胞百分比:", min_value=0, max_value=100, value=68.20) 
PLYMPH = st.number_input("淋巴细胞百分比:", min_value=0, max_value=100, value=20.91) 
PEOS = st.number_input("嗜酸性粒细胞百分比:", min_value=0, max_value=100, value=3.90) 
PBASO = st.number_input("嗜碱性粒细胞百分比:", min_value=0, max_value=100, value=0) 
PMONO = st.number_input("单核细胞百分比:", min_value=0, max_value=100, value=8.60) 
NEUT = st.number_input("中性粒细胞计数:", min_value=0, max_value=100, value=3.88) 
LYMPH = st.number_input("淋巴细胞计数:", min_value=0, max_value=100, value=1.19) 
EOS = st.number_input("嗜酸性粒细胞计数:", min_value=0, max_value=100, value=0.22) 
BASO = st.number_input("嗜碱性粒细胞计数:", min_value=0, max_value=100, value=0.00) 
MONO = st.number_input("单核细胞计数:", min_value=0, max_value=100, value=0.49)    
RBC = st.number_input("红细胞计数:", min_value=0, max_value=20, value=4.30) 
HB = st.number_input("血红蛋白浓度:", min_value=0, max_value=200, value=120) 
HCT = st.number_input("红细胞压积:", min_value=0, max_value=70, value=40) 
...
PDW = st.number_input("血小板分布宽度:", min_value=0, max_value=100, value=16.40) 
