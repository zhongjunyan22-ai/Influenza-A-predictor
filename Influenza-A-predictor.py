...
PEOS = st.number_input("嗜酸性粒细胞百分比:", min_value=0.00, max_value=100.00, value=3.90, step=0.01) 
PBASO = st.number_input("嗜碱性粒细胞百分比:", min_value=0.00, max_value=100.00, value=0.01, step=0.01) 
PMONO = st.number_input("单核细胞百分比:", min_value=0.00, max_value=100.00, value=8.60, step=0.01) 
NEUT = st.number_input("中性粒细胞计数:", min_value=0.00, max_value=100.00, value=3.88, step=0.01) 
LYMPH = st.number_input("淋巴细胞计数:", min_value=0.00, max_value=100.00, value=1.19, step=0.01) 
EOS = st.number_input("嗜酸性粒细胞计数:", min_value=0.00, max_value=100.00, value=0.22, step=0.01) 
BASO = st.number_input("嗜碱性粒细胞计数:", min_value=0.00, max_value=100.00, value=0.01, step=0.01) 
MONO = st.number_input("单核细胞计数:", min_value=0.00, max_value=100.00, value=0.49, step=0.01)    
RBC = st.number_input("红细胞计数:", min_value=0.00, max_value=20.00, value=4.30, step=0.01) 
HB = st.number_input("血红蛋白浓度:", min_value=0.00, max_value=200.00, value=120.00, step=0.01) 
HCT = st.number_input("红细胞压积:", min_value=0.00, max_value=70.00, value=40.00, step=0.01) 
MCV = st.number_input("红细胞平均体积:", min_value=0.00, max_value=100.00, value=84.00, step=0.01) 
MCH = st.number_input("平均红细胞血红蛋白含量:", min_value=0.00, max_value=70.00, value=27.00, step=0.01) 
