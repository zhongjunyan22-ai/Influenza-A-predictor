...
# 数值型变量输入框
Age = st.number_input("Age(year/years):", min_value=0.00, max_value=120.00, value=8.00, step=0.01)
WBC = st.number_input("WBC(10^9/L):", min_value=0.00, max_value=200.00, value=5.69, step=0.01) 
...
NEUT = st.number_input("NEUT(10^9/L):", min_value=0.00, max_value=100.00, value=3.88, step=0.01) 
LYMPH = st.number_input("LYMPH(10^9/L):", min_value=0.00, max_value=100.00, value=1.19, step=0.01) 
EOS = st.number_input("EOS(10^9/L):", min_value=0.00, max_value=100.00, value=0.22, step=0.01) 
BASO = st.number_input("BASO(10^9/L):", min_value=0.00, max_value=100.00, value=0.01, step=0.01) 
MONO = st.number_input("MONO(10^9/L):", min_value=0.00, max_value=100.00, value=0.49, step=0.01)    
RBC = st.number_input("RBC(10^12/L):", min_value=0.00, max_value=20.00, value=4.30, step=0.01) 
HB = st.number_input("HB(g/L):", min_value=0.00, max_value=200.00, value=120.00, step=0.01) 
HCT = st.number_input("HCT(%):", min_value=0.00, max_value=70.00, value=40.00, step=0.01) 
MCV = st.number_input("MCV(fl):", min_value=0.00, max_value=100.00, value=84.00, step=0.01) 
MCH = st.number_input("MCH(pg):", min_value=0.00, max_value=70.00, value=27.00, step=0.01) 
MCHC = st.number_input("MCHC(g/L):", min_value=0.00, max_value=500.00, value=328.00, step=0.01) 
RDW_CV = st.number_input("RDW_CV(%):", min_value=0.00, max_value=30.00, value=13.00, step=0.01) 
PLT = st.number_input("PLT(10^9/L):", min_value=0.00, max_value=900.00, value=330.00, step=0.01) 
PCT = st.number_input("PCT(%):", min_value=0.00, max_value=10.00, value=0.30, step=0.01 )
MPV = st.number_input("MPV(fl):", min_value=0.00, max_value=30.00, value=9.30, step=0.01) 
PDW = st.number_input("PDW(%):", min_value=0.00, max_value=100.00, value=16.40, step=0.01) 
hs_CRP = st.number_input("hs_CRP(mg/L):", min_value=0.00, max_value=900.00, value=0.36, step=0.01) 
